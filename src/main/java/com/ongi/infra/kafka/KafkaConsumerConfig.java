...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, EmailMessageDto> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "ongi-email-consumer");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false);
        props.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, 10);
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ongi.batch.dto");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, EmailMessageDto.class.getName());
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                new DeadLetterPublishingRecoverer(kafkaTemplate,
                        (record, ex) -> new org.apache.kafka.common.TopicPartition(
                                KafkaTopicConfig.EMAIL_SEND_DLQ_TOPIC, record.partition())),
